...
create table notification (
    ...
    constraint ck_notification_type check (type in ('NEW_BOARD_COMMENT', 'NEW_BOARD_COMMENT_REPLY', 'DM', 'LIKE_OF_BOARD', 'LIKE_OF_BOARD_COMMENT', 'NEW_FOLLOWER', 'NEW_BOARD_OF_FOLLOWING'))
);
-- drop table notification;
create sequence seq_notification_id;

insert into notification
values (seq_notification_id.nextval, 'qwerty', 'NEW_BOARD_COMMENT', '<a href="#">honggd</a>님이 <a href="#">Helloworld</a> 게시글에 댓글을 작성했습니다', default, default);
insert into notification
values (seq_notification_id.nextval, 'qwerty', 'DM', '<a href="#">admin</a>님이 <a href="#">DM</a>을 보냈습니다.', default, default);
insert into notification
values (seq_notification_id.nextval, 'abcde', 'NEW_BOARD_OF_FOLLOWING', '<a href="#">qwerty</a>가 새 게시글 <a href="#">Winter is coming...</a>을 등록했습니다.', default, default);
